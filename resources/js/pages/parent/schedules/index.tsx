...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Schedules', href: '/parent/schedules' },
];
...
export default function ParentSchedules({ schedules, filters }: Props) {
    const [search, setSearch] = useState(filters.search || '');
    const [viewingSchedule, setViewingSchedule] = useState<Schedule | null>(null);

    const handleSearchChange = (value: string) => {
        setSearch(value);
        router.get('/parent/schedules', { search: value }, { preserveState: true, replace: true });
    };
        ...
        <ParentLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">View class schedules for your children's departments</p>
                </div>
