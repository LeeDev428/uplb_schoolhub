...
export default function AttendanceIndex({ students, sections, filters }: Props) {
    const [search, setSearch] = useState(filters.search || '');
    const [section, setSection] = useState(filters.section || 'all');

    const navigate = (params: Record<string, string>) => {
        router.get('/teacher/attendance', params, { preserveState: true, preserveScroll: true });
    };
        ...
        <TeacherLayout>
            ...
            <div className="space-y-6 p-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">Record and manage student attendance</p>
                </div>
