...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Schedules', href: '/student/schedules' },
];
...
export default function StudentSchedules({ schedules, filters }: Props) {
    const [search, setSearch] = useState(filters.search || '');
    const [viewingSchedule, setViewingSchedule] = useState<Schedule | null>(null);

    const handleSearchChange = (value: string) => {
        setSearch(value);
        router.get('/student/schedules', { search: value }, { preserveState: true, replace: true });
    };
